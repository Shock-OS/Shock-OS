...
then
    #gsettings set org.gnome.desktop.background picture-uri "'file:///usr/share/shockos/branding/backgrounds/shockos-background.xml'"
    #gsettings set org.gnome.desktop.background picture-uri-dark "'file:///usr/share/shockos/branding/backgrounds/shockos-background.xml'"
    ...
    #shockos-gnome-layouts-cli --defaults panel
